...
public interface TodoDao {
    ...
    @Query("SELECT * FROM TodoItem WHERE timestamp >= :startDate AND timestamp <= :endDate ORDER BY timestamp DESC")
    List<TodoItem> getTodosInRange(long startDate, long endDate);
}
